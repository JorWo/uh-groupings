...
const GroupingMembersTableSkeleton = ({ groupingExtension }: { groupingExtension?: string }) => {
    const pageSize = 20; // Average number of rows

    return (
        <div className="px-4 py-1">
            <div className="flex flex-col md:flex-row md:justify-between">
                <h1 className="font-bold text-[32px] capitalize">{groupingExtension ?? 'All Members'}</h1>
